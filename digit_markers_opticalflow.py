...
class Markers_OF:  # Optical Flow
    ...
    def track(self, frame):
        ...
        if self.is_first_frame:
            ...
            keypoints_mask = np.ones((keypoint_count,), dtype=np.bool)
            ...
            mask_indices_mapping = np.arange(len(prev_keypoints))[available_keypoints_indices]
