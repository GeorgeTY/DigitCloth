...
#define L_Pos_X_Axis_start -35
#define L_Pos_Y_Axis_start 125
#define L_Pos_Z_Angle_start -70
#define L_Pos_X_Axis_end -120
#define L_Pos_Y_Axis_end 125
#define L_Pos_Z_Angle_end -70
#define R_Pos_X_Axis 45
...
int main(int argc,char **argv){
    ...
    msg_L.X_Axis=L_Pos_X_Axis_start;msg_L.Y_Axis=L_Pos_Y_Axis_start;msg_L.Z_Angle=L_Pos_Z_Angle_start;
    ...
    {   
        if(StartToEnd){
            msg_L.X_Axis-=0.5;
            if(msg_L.X_Axis<L_Pos_X_Axis_end)
                StartToEnd=!StartToEnd;
        }else{
            msg_L.X_Axis+=0.5;
            if(msg_L.X_Axis>L_Pos_X_Axis_start)
                StartToEnd=!StartToEnd;
        }
