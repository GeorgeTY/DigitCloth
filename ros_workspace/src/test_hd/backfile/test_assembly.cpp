...
#define Modify 0.065
#define frequency 15
#define Target_height 10000
#define Theta_threshold 50.0
#define w_deg 5.0

#define COUNT_MODE // 总计运动十次，用于测量移动距离
...
void Move_cloth::Set_MoveDistance(float distance, hd_servo::EndPos &msg_L)
{
...
int main(int argc, char **argv)
{
    ...
    move_cloth_in.Init();
    move_cloth_in.Set_MoveDistance(12, msg_L);
