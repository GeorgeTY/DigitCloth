...
L_digit_folder="/home/jhz/catkin_ws/src/get_height/digiteye/R_calibrate_ballR2"
R_serial_number="D00048"
...
if R_digit_on==1:
    ...
    digit_R= Digit(R_serial_number, "Left Gripper")
    digit_R.connect()
    print(digit_R.info())
...
if L_digit_on==1:
    ...
    ###########VGA Mode############
    vga_res = Digit.STREAMS["VGA"]
    digit_L.set_resolution(vga_res)
    # Change DIGIT FPS to 15fps
    fps_15 = Digit.STREAMS["VGA"]["fps"]["15fps"]
    digit_L.set_fps(fps_15)
...
def talker():
    pub = rospy.Publisher('digit_heigth', Height, queue_size=10)
    ...
    while not rospy.is_shutdown():
        ...
        Height.height_datas=height_array
